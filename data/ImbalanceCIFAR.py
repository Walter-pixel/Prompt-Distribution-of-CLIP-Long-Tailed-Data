...
class IMBALANCECIFAR10(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, phase, imbalance_ratio, resolution, root = '/gruntdata5/kaihua/datasets', imb_type='exp',
        ...
        if self.train:
            ...
            if test_imb_ratio:
                ...
                self.img_num_list = self.get_img_num_per_cls(self.cls_num, imb_type, imb_factor=1.0,
                                                             reverse=reverse)
            # print(f"!!! Have set cifar image to 224x224 for testing set !!!")
            self.transform = transforms.Compose([
                             transforms.Resize(resolution),
                             transforms.ToTensor(),
                             transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),
