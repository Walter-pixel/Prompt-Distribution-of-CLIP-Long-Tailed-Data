...
import time
from clip_customize.Places_clip_accept_ClsSpec_generator import*
import yaml
...
(3) this script uses python file: "clip_customize/Places_clip_accept_ClsSpec_generator.py"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_sample', type=int, help='sampling how many times during training and testing.')
